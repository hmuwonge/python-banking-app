...
class UserProfile(TimeStampedModel):
    ...
    date_of_birth = models.DateField(_("Date of Birth"), blank=True, default=settings.DEFAULT_BIRTH_DATE)
    ...
    phone_number = PhoneNumberField(_("Phone Number"), max_length=30, blank=True, null=True)
...
class NextOfKin(TimeStampedModel):
    ...
    title = models.CharField(_("Salutation"), max_length=5, choices=Salutation.choices, default=Salutation.MR.value)
    ...
    gender = models.CharField(_("Gender"),max_length=8,choices=Gender.choices, default=Gender.MALE.value)
